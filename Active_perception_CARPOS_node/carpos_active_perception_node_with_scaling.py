...
def start_observation_callback(data):
    ...
    if iteration_counter == 1:
        ...
        #### ADDITION FOR SCALING 
        tomato_r0_prev = np.array(data['tomato_r0'])
        ...
        mdic_prev = {"p_array": p_train_prev, "Q_array": Q_train_prev, "dt": dt_prev, "Rrobc": Rrobc_prev, "tomato_r0": tomato_r0_prev}
    ...
    mdic = {"p_array": p_array[:,1:], "Q_array": Q_array[:,1:], "dt": dt, "Rrobc": R0c, "tomato_r0":tomato_r0}
...
if __name__ == '__main__':
    ...
    #### ADDITION FOR SCALING 
    rospy.Subscriber("/tomato_radius", Float64, get_tomato_radius)
